...
contract Battle {
    ...
    address private immutable gameItemAddress;
    ...
    function battle(
        ...
        if (_gameItemsContract.balanceOf(p2, p2TokenId) == 0) {
            _removeCommitment(p1);
            _removeCommitment(p2);
            emit Cheater(p2);
    ...
    function _findWinner(
        ...
        /// Check P1 Beats
        IGameItems.GameItemMetadata memory p1Item = itemsContract
            .getOnChainToken(p1TokenId);
        ...
        /// Check P2 Beats
        IGameItems.GameItemMetadata memory p2Item = itemsContract
            .getOnChainToken(p2TokenId);
    ...
    function _mintForWinner(
        IGameItems itemContract,
        uint8 result,
        uint256 p1TokenId,
        address p1,
        uint256 p2TokenId,
